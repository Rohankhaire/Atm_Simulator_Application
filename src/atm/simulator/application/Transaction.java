...
public class Transaction extends JFrame implements ActionListener {
    ...
    JButton deposit, withdrawl, ministatement, fastcash, pinchange, balanceinquire, exit;
    String cardno, pin;

    public Transaction(String cardno, String pin) {
        this.cardno = cardno;
        this.pin = pin;
        ...
        balanceinquire = new JButton("Balance Inquiry");
        balanceinquire.setBounds(170, 485, 150, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == exit) {
            ...
            setVisible(false);
            new Withdrawal(pin, cardno).setVisible(true);
        }
            ...
            setVisible(false);
            new BalanceInquiry(pin, cardno).setVisible(true);
        }
